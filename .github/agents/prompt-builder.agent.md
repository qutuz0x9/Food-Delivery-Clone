...
name: 'Prompt Builder'
tools: ['search/codebase', 'edit/editFiles', 'web/fetch', 'web/githubRepo', 'read/problems', 'execute/getTerminalOutput', 'search', 'searchResults', 'read/terminalLastCommand', 'read/terminalSelection', 'search/usages', 'terraform', 'Microsoft Docs', 'context7']
---
